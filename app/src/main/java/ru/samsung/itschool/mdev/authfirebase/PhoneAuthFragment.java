...
import ru.samsung.itschool.mdev.authfirebase.databinding.FragmentPhoneAuthBinding;
...
public class PhoneAuthFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mBinding.buttonStartVerification.setOnClickListener(v -> {
            if (!validatePhoneNumber()) {
                return;
            }
            startPhoneNumberVerification(mBinding.fieldPhoneNumber.getText().toString());
        });
        mBinding.buttonVerifyPhone.setOnClickListener(v -> {
        ...
        mBinding.buttonResend.setOnClickListener(v -> {
            if (!validatePhoneNumber()) {
                return;
            }
