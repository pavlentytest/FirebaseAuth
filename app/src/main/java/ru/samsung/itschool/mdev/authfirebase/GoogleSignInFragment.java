...
import ru.samsung.itschool.mdev.authfirebase.databinding.FragmentGoogleSignInBinding;
...
public class GoogleSignInFragment extends BaseFragment {
    ...
    private FragmentGoogleSignInBinding mBinding;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mBinding = FragmentGoogleSignInBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mBinding.disconnectButton.setOnClickListener(v -> revokeAccess());
